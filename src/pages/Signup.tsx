...
const Signup = () => {
  ...
  const handleEmailSignup = async (e: React.FormEvent) => {
    ...
    // Force logout to enforce email verification approach
        ...
        <div className="mx-auto w-full max-w-md">
          ...
          <div className="text-center">
            ...
            <p className="mt-2 text-muted-foreground">
              Start proving your income in minutes
            </p>
          </div>
        ...
        <div className="max-w-lg text-center">
          <div className="mb-8 rounded-2xl border border-border bg-card p-8 shadow-elevated">
            ...
            <h3 className="mb-2 text-xl font-semibold text-foreground">
              Join 50,000+ Gig Workers
            </h3>
            <p className="text-muted-foreground">
              Get approved for loans, apartments, and credit cards with bank-verified income reports.
            </p>
          </div>
